<!-- Navigation -->
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                <div class="navbar-header">
                    <a class="navbar-brand" href="dashboardAdministrativo">Global Costumer Manager</a>
                </div>
                ...
                <ul class="nav navbar-nav navbar-left navbar-top-links">
                    <li><a href="http://globalgsl.com.br/"><i class="fa fa-home fa-fw"></i> Website</a></li>
                </ul>
                ...
                <ul class="nav navbar-right navbar-top-links">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            ...
                            <li class="divider"></li>
                            <li><a href="loginAdministrativo"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                            </li>
                        </ul>
                    </li>
                </ul>
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            <li>
                                <a href="dashboardAdministrativo"><i class="fa fa-dashboard fa-fw"></i> Início</a>
                            </li>
                            <li>
